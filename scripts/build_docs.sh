#!/usr/bin/env bash
# Build static DocC site(s) for the MagentaRT SPM targets into ./docs
# (GitHub Pages-ready), with optional LLM-Markdown export.
#
# Usage:
...
TARGETS="${TARGETS:-MagentaRT MagentaRTPlayer}"
HOSTING_BASE_PATH="${HOSTING_BASE_PATH:-MagentaRT}"
REPO_URL="${REPO_URL:-https://github.com/mnmly/MagentaRT}"
...
# Preview: first target only — preview-documentation is single-target.
